...
namespace KatsukiBot.Commands.Twitch.Handler.Entities {
    ...
    public interface ICommandModule {
        ...
        TwitchBaseCommandModule GetInstance(IServiceProvider services);
    }
    ...
    public class TransientCommandModule : ICommandModule {
        ...
        public TwitchBaseCommandModule GetInstance(IServiceProvider services)
            => this.ModuleType.CreateInstance(services) as TwitchBaseCommandModule;
    }
    ...
    public class SingletonCommandModule : ICommandModule {
        ...
        /// </summary>
        public TwitchBaseCommandModule Instance { get; }
        ...
        internal SingletonCommandModule(Type t, IServiceProvider services) {
            this.ModuleType = t;
            this.Instance = t.CreateInstance(services) as TwitchBaseCommandModule;
        }
