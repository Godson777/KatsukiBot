...
namespace KatsukiBot.Commands.Twitch.Handler.Converters {
    public class DateTimeConverter : IArgumentConverter<DateTime> {
        Task<Optional<DateTime>> IArgumentConverter<DateTime>.ConvertAsync(string value, TwitchCommandContext ctx) {
    ...
    public class DateTimeOffsetConverter : IArgumentConverter<DateTimeOffset> {
        Task<Optional<DateTimeOffset>> IArgumentConverter<DateTimeOffset>.ConvertAsync(string value, TwitchCommandContext ctx) {
    ...
    public class TimeSpanConverter : IArgumentConverter<TimeSpan> {
        ...
        Task<Optional<TimeSpan>> IArgumentConverter<TimeSpan>.ConvertAsync(string value, TwitchCommandContext ctx) {
            if (value == "0")
